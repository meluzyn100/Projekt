...
function Animation(List, days = 8, maxDay = nothing,                                # Funkcja generująca animacje obiegu planet
                    elips = true, directory = nothing)      
    """
    ...
    Przykładowym argumentem tej funkcji jest np.
    ["earth", "mercury", ("Gwiazda Smierci", 3.15581497635456e7, 0.00677672, 1.0820947453737917e11, 1.149691), 6, 365, true]

    List - lista planet
    days - co ile dni mierzymy pozycje planety (opcionalne, domyślnie 8)
    naxDay - dzień do którego liczymy pozycję planet (opcionalne)
...
<<<<<<< HEAD
        ...
        if elips                                                                    # Sprawdzamy czy użytkownik chce wygenerowane tory ruchu planet
...
>>>>>>> 6b6fc2202a01bad62be12117a2134229a2f2e46c
    ...
    gif(anim, "$directory", fps = 15)                                               # Zapisujemy animacje (domyślnie 15 fps)
end
